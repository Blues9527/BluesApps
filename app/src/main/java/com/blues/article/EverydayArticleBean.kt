...
class EverydayArticleBean {
    ...
    class Data {
        ...
        var digest: String? =
            null // 娜卡.戴莱尼同她母亲从戏园里回来，那天，戏园里演了一出戏名叫《叶甫盖尼.奥涅金》的戏剧。她跑到自己的屋子里去，很快脱去衣服，散开发辫，穿了一

        @JSONField(name = "title")
        var title: String? = null // 散戏之后
        ...
        class Date {
            @JSONField(name = "curr")
            var curr: String? = null // 20170217

            @JSONField(name = "next")
            var next: String? = null // 20170218

            @JSONField(name = "prev")
            var prev: String? = null // 20170216
        }
    }
}