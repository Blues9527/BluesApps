...
/**
 * File: com.blues.kaiyan.list.view.OpenEyeSearchActivity.kt
 * Description: xxx
 *
 * @author: lanhuajian
 * @time: 2021/7/30
...
class OpenEyeSearchActivity : BaseKoinActivity(), TextWatcherAdapter, View.OnClickListener,
    ...
    private lateinit var mResultAdapter: RecyclerArrayAdapter<OpenEyeEntity.ItemListBean.DataBean>
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        etSearch = findViewById<EditText>(R.id.et_search).apply {
            addTextChangedListener(this@OpenEyeSearchActivity)
            setOnEditorActionListener(this@OpenEyeSearchActivity)
        }
        ivClear = findViewById<ImageView>(R.id.iv_clear).apply {
            visibility = View.GONE
            setOnClickListener(this@OpenEyeSearchActivity)
        }
        ...
        rvHotSearchResult = findViewById<EasyRecyclerView>(R.id.rv_hot_search).apply {
            ...
            adapter = object : RecyclerArrayAdapter<String>(this@OpenEyeSearchActivity) {
                override fun OnCreateViewHolder(parent: ViewGroup,
                    viewType: Int): BaseViewHolder<*> {
                    return OEHotSearchViewHolder(parent)
                }
        ...
        rvSearchResult.apply {
            setLayoutManager(LinearLayoutManager(this@OpenEyeSearchActivity))
            adapter = object :
                RecyclerArrayAdapter<OpenEyeEntity.ItemListBean.DataBean>(this@OpenEyeSearchActivity) {
                override fun OnCreateViewHolder(parent: ViewGroup,
                    viewType: Int): BaseViewHolder<*> {
                    return OESearchResultViewHolder(parent)
                }
