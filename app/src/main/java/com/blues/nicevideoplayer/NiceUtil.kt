...
object NiceUtil {
    ...
    fun hideActionBar(context: Context?) {
        ...
        scanForActivity(context)!!.window.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
    ...
    fun savePlayPosition(context: Context, url: String?, position: Long) {
        context.getSharedPreferences("NICE_VIDEO_PALYER_PLAY_POSITION", Context.MODE_PRIVATE).edit()
                .putLong(url, position).apply()
    }
