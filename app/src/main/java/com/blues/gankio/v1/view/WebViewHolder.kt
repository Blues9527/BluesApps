...
import com.blues.gankio.v1.model_web.model.WebEntity
import com.blues.R
...
class WebViewHolder(parent: ViewGroup?) :
    BaseViewHolder<WebEntity.ResultsBean>(parent, R.layout.item_test) {
    ...
    override fun setData(data: WebEntity.ResultsBean) {
        super.setData(data)
