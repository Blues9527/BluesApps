package com.example.lanhuajian.blues.framework.widget.immersionbar;
...
public class ImmersionBar {
     ...
     * @return the immersion bar
     */
    public ImmersionBar statusBarColorRes(@ColorRes int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public ImmersionBar statusBarColorTransformRes(@ColorRes int statusBarColorTransform) {
        mBarParams.statusBarColorTransform = ContextCompat.getColor(mActivity, statusBarColorTransform);
        return this;
    }
