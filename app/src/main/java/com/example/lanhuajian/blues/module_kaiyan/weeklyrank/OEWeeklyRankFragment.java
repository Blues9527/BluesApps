package com.example.lanhuajian.blues.module_kaiyan.weeklyrank;
...
public class OEWeeklyRankFragment extends BaseFragment implements OpenEyeContract.iOpenEyeView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initLayout(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        iPresenter.getRankList(RequestUrl.KaiYanType.WEEKLY);
        ...
        hotRankErv.setAdapter(mAdapter = new RecyclerArrayAdapter<OpenEyeEntity.ItemListBean>(getmContext()) {
            ...
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                return new OEWeeklyRankViewHolder(parent);
            }
        });
