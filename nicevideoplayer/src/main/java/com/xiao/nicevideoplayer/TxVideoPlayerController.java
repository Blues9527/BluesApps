...
public class TxVideoPlayerController
    ...
    private boolean shouldShowLength = true;//默认显示
    ...
    @Override
    public void setShouldShowLength(boolean shouldShowLength) {
    ...
    protected void reset() {
        ...
        mLength.setVisibility(shouldShowLength ? View.VISIBLE : View.GONE);
