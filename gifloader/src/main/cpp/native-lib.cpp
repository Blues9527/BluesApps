...
#define TAG    "blues-jni-gifloader" // 这个是自定义的LOG的标识
#define LOGD(...)  __android_log_print(ANDROID_LOG_DEBUG,TAG,__VA_ARGS__) // 定义LOGD类型
#define LOGE(...)  __android_log_print(ANDROID_LOG_ERROR,TAG,__VA_ARGS__) // 定义LOGE类型

extern "C"
JNIEXPORT jlong JNICALL
Java_com_blues_gifloader_GifHandler_openFileNative(JNIEnv *env, jobject instance, jstring path_) {
...
Java_com_blues_gifloader_GifHandler_getWidthNative(JNIEnv *env, jobject thiz, jlong gif_info) {
    //获取宽
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_blues_gifloader_GifHandler_getHeightNative(JNIEnv *env, jobject thiz, jlong gif_info) {
    //获取高
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_blues_gifloader_GifHandler_getLengthNative(JNIEnv *env, jobject thiz, jlong gif_info) {
    //获取图片帧数
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_blues_gifloader_GifHandler_renderFrameNative(JNIEnv *env, jobject thiz, jlong gif_info,
